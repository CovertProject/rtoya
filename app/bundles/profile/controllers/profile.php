...
class Profile_Profile_Controller extends Base_Controller
{
    ...
    public function get_index()
    {
        ...
        $form_values['account_website'] = Input::old('account_website') != '' ? Input::old('account_website') : $profile->getWebsite();
    ...
    public function post_account_submit()
    {
        ...
        $profile = new ProfileEntity(Auth::user()->id);
        ...
        $profile->setWebsite(Input::get('account_website'));
