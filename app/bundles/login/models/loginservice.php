...
class LoginService {
    ...
    public static function set_remember_me()
    {
        ...
        Cookie::forever('rtoya_remember_me', serialize($cookie));
    }
    ...
    public static function check_remember_me()
    {
        ...
        $cookie   = unserialize(Cookie::get('rtoya_remember_me'));
    ...
    public static function logout()
    {
        ...
        Cookie::forget('rtoya_remember_me');
    ...
    public static function set_session()
    {
        ...
        Session::put('rt_profile', $profile);
        Session::put('rt_settings', $settings);
    }
}
